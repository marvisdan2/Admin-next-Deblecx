...
const MainWrapper = styled(Card)(({ theme }) => ({
  ...
  [theme.breakpoints.down(500)]: {
    '& .MuiFormControlLabel-root': { display: 'none' },
  },
}))
...
const StyledFormControlLabel = styled(FormControlLabel)({
  ...
  '& .MuiTypography-root': { fontSize: 14, color: 'text.secondary', lineHeight: 1 },
})
    ...
    <MainWrapper>
      <ContentWrapper>
        ...
        <StyledFormControlLabel
          label="Notifications"
          control={<Switch size="small" defaultChecked={true} />}
        />
