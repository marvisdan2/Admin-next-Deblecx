...
// ==============================================================
type UserDetailsProps = { data: any }
// ==============================================================
      ...
      {data ? (
        <>
          ...
          <Stack alignItems="center">
            <Avatar src={data.avatar} sx={{ width: 120, height: 120, backgroundColor: 'white' }} />
            <H6 fontSize={16} mt={2}>
              {data.name}
            </H6>
...
// ===================================================================
type ListItemProps = { title: string; Icon: SvgIconComponent }
// ===================================================================
