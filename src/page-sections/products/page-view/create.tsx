...
export default function CreateProductPageView() {
  ...
  const handleDropFile = useCallback((acceptedFiles: File[]) => {
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item sm={6} xs={12}>
                      <TextField
                        ...
                        onBlur={handleBlur}
                        onChange={handleChange}
                        value={values.pro_model}
                        helperText={touched.pro_model && errors.pro_model}
                        error={Boolean(touched.pro_model && errors.pro_model)}
                      />
                    </Grid>
