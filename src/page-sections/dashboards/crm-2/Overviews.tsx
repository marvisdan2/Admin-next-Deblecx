  ...
  const LIST = [
    {
      ...
      color: 'primary.main',
      element: [
        { name: 'Draft', value: 6, progress: 42 },
        { name: 'Not Sent', value: 8, progress: 21 },
        { name: 'Unpaid', value: 3, progress: 14 },
        { name: 'Overdue', value: 0, progress: 5 },
        { name: 'Paid', value: 6, progress: 7 },
      ],
    },
    {
