...
const VerifyView = () => {
  ...
  const { resendCode, emailVerify } = useContext(AuthContext);
    ...
    <Container>
      <Box textAlign="center" py={{ sm: 6, xs: 4 }}>
        ...
        >
          ...
          sent to your registered email address. Enter the code in the field
          below to confirm your email and complete the verification process.
        </Paragraph>
              ...
              <Box
                ...
                sx={{
                  ...
                  backgroundColor: (theme) =>
                    isDark(theme) ? "grey.800" : "grey.100",
