  ...
  const chartOptions: ApexOptions = {
    ...
    plotOptions: {
      radialBar: {
        ...
        startAngle: -100,
        hollow: { size: "60%" },
        track: { background: theme.palette.divider, strokeWidth: "97%" },
        dataLabels: {
          name: { fontSize: "14px", fontWeight: "500", color: theme.palette.text.secondary },
          value: { offsetY: -35, fontSize: "14px", fontWeight: "600" }
        }
      }
    },
    states: {
    ...
    fill: { type: "solid", colors: [theme.palette.primary.main] },
