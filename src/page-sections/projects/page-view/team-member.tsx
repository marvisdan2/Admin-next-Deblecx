      ...
      <Grid container spacing={3} pt={3}>
        ...
        <Grid item md={4} xs={12}>
          <Card sx={{ padding: 3, mb: 3 }}>
            ...
            {recentActivity.map(({ Icon, date, id, title }) => (
...
const todoList = [
  { id: 1, title: 'Create Minimal Logo', date: 'Due In 2 Days', status: 'Pending' },
  { id: 2, title: 'Stock Market Exchange', date: 'Due In 3 Days', status: 'Processing' },
  { id: 3, title: 'Shopping & Groccery', date: 'Due In 5 days', status: 'Pending' },
  { id: 4, title: 'Football Match', date: 'Due In 1 Day', status: 'Completed' },
]
