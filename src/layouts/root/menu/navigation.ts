export const PAGES_MENUS = [
  {
    ...
    child: [
      ...
      { id: 8, title: 'LMS', href: '/dashboard/learning-management' },
    ],
  },
  {
    id: 2,
    ...
    child: [
      ...
      // { id: 6, title: 'Career Details', href: '/career/designer' },
      { id: 1, title: 'Shop', href: '/products' },
      { id: 7, title: 'Checkout', href: '/checkout' },
      { id: 8, title: 'Cart', href: '/cart' },
    ],
  },
  {
    id: 3,
