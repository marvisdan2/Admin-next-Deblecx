...
const StyledRoot = styled(Card)(({ theme }) => ({
  ...
  '& .progress-wrapper': { flexGrow: 1, marginInline: '1rem' },
}))
...
export default function Acquisitions() {
  ...
  const RESULTS = [
    { id: 1, progress: 10, title: 'Application' },
    { id: 2, progress: 80, title: 'Shortlisted' },
    { id: 3, progress: 60, title: 'Certified' },
    { id: 4, progress: 70, title: 'On hold' },
    { id: 5, progress: 20, title: 'Rejected' },
    { id: 6, progress: 60, title: 'Hired' },
  ]
