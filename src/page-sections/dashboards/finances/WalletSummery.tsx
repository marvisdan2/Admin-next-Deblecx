...
export default function WalletSummery() {
  ...
  // REACT CHART OPTIONS
  const chartOptions = (base: string, track: string) => {
      ...
      <Stack spacing={3}>
        <FlexBetween
          ...
          <Chart
            ...
            series={[70]}
            type="radialBar"
            options={chartOptions(theme.palette.primary.main, theme.palette.primary[100])}
          />
        </FlexBetween>
        ...
        <FlexBetween
          ...
          <Chart
            ...
            series={[30]}
            type="radialBar"
            options={chartOptions(theme.palette.grey[500], theme.palette.grey[200])}
          />
        </FlexBetween>
      </Stack>
    </Card>
