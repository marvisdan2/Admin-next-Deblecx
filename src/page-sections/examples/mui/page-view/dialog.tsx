...
type SlideUpProps = TransitionProps & { children: ReactElement<any, any> }

const SlideUp = forwardRef((props: SlideUpProps, ref: Ref<unknown>) => (
...
export default function MuiDialogPageView() {
  ...
  const handleMaxWidthChange = (event: SelectChangeEvent<typeof maxWidth>) => {
    setMaxWidth(event.target.value as typeof maxWidth)
  }
  ...
  return (
    <ComponentPageLayout title="Dialog">
        ...
        <Grid item md={4} xs={12}>
          <Block title="Basic">
            ...
            <Dialog onClose={handleCloseBasicDialog} open={openBasicDialog}>
              ...
              <List sx={{ pt: 0 }}>
                {emails.map((email) => (
                  <ListItem disablePadding disableGutters key={email}>
        ...
        <Grid item md={4} xs={12}>
          <Block title="Optional sizes">
            ...
            <Dialog
              maxWidth={maxWidth}
              fullWidth={fullWidth}
              open={openMaxWidthDialog}
              onClose={handleCloseMaxWidthDialog}
            >
