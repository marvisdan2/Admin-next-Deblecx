...
export default function MuiPickersPageView() {
  ...
  const [selectDate, setSelectedDate] = useState<Date | null>(new Date(2023, 1, 5))

  const [selectTime, setSelectTime] = useState<Date | null>(new Date(2023, 1, 5))

  return (
    <ComponentPageLayout title="Date/Time Pickers" fullLink="https://mui.com/x/react-date-pickers">
        ...
        <TabPanel value="1">
          <Grid container spacing={3}>
            <Grid item lg={6} xs={12}>
              ...
              <Block title="Static Date" sx={{ mt: 3 }}>
                <Stack spacing={4}>
                  <DatePicker
                    views={['year']}
                    label="Year only"
