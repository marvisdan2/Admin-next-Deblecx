...
// ==========================================================================
type AddContactFormProps = { handleCancel: () => void; data?: any }
// ==========================================================================

export default function AddContactForm({ handleCancel, data }: AddContactFormProps) {
  const initialValues = {
    firstName: data?.name || '',
    lastName: '',
    birthday: null,
        ...
        <Grid container spacing={3}>
          ...
          <Grid item sm={6} xs={12}>
            <TextField
              ...
              helperText={(touched.company && errors.company) as string}
            />
          </Grid>
