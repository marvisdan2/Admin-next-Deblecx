...
export const LIST_ITEMS = [
  { value: 0, Icon: Mail, id: nanoid(), title: 'All Mail', url: '/dashboard/mail/all' },
  { value: 16, Icon: Inbox, id: nanoid(), title: 'Inbox', url: '/dashboard/mail/inbox' },
  { value: 0, Icon: SendTwoTone, id: nanoid(), title: 'Sent', url: '/dashboard/mail/sent' },
  { value: 0, Icon: Edit, id: nanoid(), title: 'Draft', url: '#' },
  { value: 0, Icon: StartHalf, id: nanoid(), title: 'Starred', url: '#' },
  { value: 0, Icon: Report, id: nanoid(), title: 'Spam', url: '#' },
  { value: 0, Icon: Trash, id: nanoid(), title: 'Trash', url: '#' },
]
