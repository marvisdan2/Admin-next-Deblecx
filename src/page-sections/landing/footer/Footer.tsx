    ...
    <footer>
      <HeaderTop>
        <Container maxWidth="xl">
          <Box pt={{ sm: 12, xs: 8 }} pb={{ sm: 24, xs: 20 }}>
            <H6
              mb={4}
              color="white"
              fontWeight={700}
            ...
            <FlexBox alignItems="center" gap={2}>
              <Button href='https://mui.com/store/items/uko-client-admin-dashboard/' size="large" color="inherit" className="buy-btn">
                Buy Now
              </Button>
      ...
      <Container>
        <TicketWrapper>
          <Paragraph fontSize={{ sm: 24, xs: 18 }} fontWeight={600} mb={3}>
