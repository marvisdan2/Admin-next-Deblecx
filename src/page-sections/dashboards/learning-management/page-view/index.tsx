...
export default function LearningManagementPageView() {
  ...
  const LEARNING_CARD_LIST = [
    { price: 1023, Icon: ChartIcon, title: 'Course in Progress', color: theme.palette.info.main },
    { price: 1250, title: 'Enrolled Courses', Icon: LeafIcon, color: theme.palette.warning.main },
    { price: 1450, Icon: CrownIcon, title: 'Course Completed', color: theme.palette.primary.main },
  ]
