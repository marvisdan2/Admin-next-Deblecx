...
export default function SalesPageView() {
  const SALES_LIST = [
    { id: 1, amount: 785000, Icon: ShoppingCart, title: 'Total Orders', color: 'primary' },
    { id: 2, amount: 32654, Icon: MoneyIcon, title: 'Orders Completed', color: 'success' },
    { id: 3, amount: 1200, Icon: TrendingUp, title: 'Orders Cancelled', color: 'error' },
  ]
