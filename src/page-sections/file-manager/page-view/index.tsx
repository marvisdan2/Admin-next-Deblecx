      ...
      <Card>
        ...
        <HeadingWrapper>
          ...
          <FlexBox className="search" justifyContent="end" gap={2} flex={1}>
            <TextField placeholder="Search Folder" InputProps={{ startAdornment: <Search /> }} />
        ...
        {selected.length > 0 && (
          <TableToolbar selected={selected.length} handleDeleteRows={handleAllFilesDelete} />
        )}
        ...
        <Scrollbar autoHide={false}>
          <Table sx={{ minWidth: 700 }}>
            ...
            <FileManagerTableHead
              ...
              onSelectAllRows={handleSelectAllRows(files.map((row) => row.id))}
            />
