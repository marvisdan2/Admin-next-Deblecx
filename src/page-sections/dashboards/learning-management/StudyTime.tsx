...
const StyledChart = styled(Chart)(({ theme }) => ({
  ...
  "& .apexcharts-active": { paddingBottom: "0 !important" },
  "& .apexcharts-tooltip": {
...
export default function StudyTime() {
  ...
  const chartSeries = [
    { name: "React", data: [22, 30, 46, 50, 46, 30, 22] },
    { name: "Angular", data: [36, 40, 56, 75, 56, 40, 36] },
    { name: "Javascript", data: [50, 60, 70, 90, 70, 60, 50] }
  ];
  ...
  const chartOptions: ApexOptions = {
    ...
    plotOptions: {
      bar: { borderRadius: 6, columnWidth: "30%", rangeBarOverlap: false }
    },
    tooltip: {
      x: { show: false }
    },
  ...
  return (
    <StyledRoot>
      ...
      <StyledChart type="bar" options={chartOptions} series={chartSeries} height={260} />
    </StyledRoot>
  );
}
