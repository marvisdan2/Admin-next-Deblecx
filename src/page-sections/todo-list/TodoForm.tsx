...
export default function TodoForm({ show, handleClose, title, handleOpen }: Props) {
  ...
  return (
    <Box padding="1rem">
      ...
      <Button
        ...
        variant="contained"
        onClick={handleOpen}
        sx={{ my: '1rem', display: show ? 'none' : 'auto' }}
      >
        <Add />
      </Button>
        ...
        <Box mt={2} display={show ? 'auto' : 'none'}>
          <Stack spacing={1}>
            ...
            <FlexBox alignItems="center">
              <FormLabel component="small" sx={{ color: 'text.secondary' }}>
                Select Color
              </FormLabel>
