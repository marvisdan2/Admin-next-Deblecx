...
export default function CreateInvoicePageView() {
  ...
  const handleAddItem = (arrayHelper: FieldArrayRenderProps) => () => {
    arrayHelper.push({
      id: Date.now(),
      itemName: '',
      itemPrice: 0,
    ...
    <div className="pt-2 pb-4">
      <Card className="p-3">
        ...
        <Formik
          ...
          children={({ values, errors, touched, handleChange, handleSubmit, setFieldValue }) => {
            return (
                ...
                <StatusWrapper>
                  ...
                  >
                    {['Pending', 'Processing', 'Delivered'].map((item) => (
                      <StyledFormControl key={item} value={item} label={item} control={<Radio />} />
                    ))}
                  </RadioGroup>
                  ...
                  <Grid item md={4} sm={6} xs={12}>
                    ...
                    <Box marginBottom={2}>
                      <TextField
                        ...
                        helperText={touched.billToAddress && errors.billToAddress}
                        error={Boolean(touched.billToAddress && errors.billToAddress)}
                      />
                    </Box>
                    ...
                    <div>
                      <TextField
                        ...
                        error={Boolean(touched.billToPhone && errors.billToPhone)}
                      />
                    </div>
                  </Grid>
                  ...
                  <Grid item md={4} sm={6} xs={12}>
                    ...
                    <Box marginBottom={2}>
                      <TextField
                        ...
                        error={Boolean(touched.billFromAddress && errors.billFromAddress)}
                      />
                    </Box>
                    ...
                    <div>
                      <TextField
                        ...
                        helperText={touched.billFromPhone && errors.billFromPhone}
                        error={Boolean(touched.billFromPhone && errors.billFromPhone)}
                      />
                    </div>
                  </Grid>
                </Grid>
                      ...
                      return (
                        <Fragment>
                          <Grid item xs={12}>
                            <Button
                              variant="contained"
                              onClick={handleAddItem(arrayHelper)}
                              sx={{ marginBottom: 2 }}
                            >
                              Add New Item
                            </Button>
