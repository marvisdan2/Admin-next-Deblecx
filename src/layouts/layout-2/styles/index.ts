...
export const MainMenu = styled('div')(({ theme }) => ({
  ...
  '.navigation-list': { paddingInline: '1rem' },
}))
...
export const SubMenuItem = styled('div', {
  ...
  '.title': { color: active ? theme.palette.primary.main : theme.palette.text.secondary },
  '.dot': { backgroundColor: active ? theme.palette.primary.main : theme.palette.text.secondary },
  '&:hover': {
...
export const MobileSidebarWrapper = styled('div', {
  ...
  '.main-list': {
    ...
    '.navigation-list': { paddingInline: '1rem', paddingBottom: '.75rem' },
  },
