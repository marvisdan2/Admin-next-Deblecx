...
export default function MuiChipPageView() {
  return (
    <ComponentPageLayout title="Chip">
      <Block title="Basic">
      ...
      <Block title="With Avatar">
        <Stack mb={2} direction="row" flexWrap="wrap" columnGap={3} rowGap={2}>
          <Chip
            label="Default"
            color="default"
            avatar={<Avatar alt="User" src="/static/user/user-10.png" />}
          />
          <Chip
            label="Primary"
            color="primary"
            avatar={<Avatar alt="User" src="/static/user/user-11.png" />}
          />
          <Chip
            label="Secondary"
            color="secondary"
            avatar={<Avatar alt="User" src="/static/user/user-12.jpg" />}
          />
          <Chip
            label="Success"
            color="success"
            avatar={<Avatar alt="User" src="/static/user/user-13.png" />}
          />
          <Chip
            label="Warning"
            color="warning"
            avatar={<Avatar alt="User" src="/static/user/user-14.png" />}
          />
          <Chip
            label="Error"
            color="error"
            avatar={<Avatar alt="User" src="/static/user/user-15.png" />}
          />
        </Stack>
        ...
        <Stack direction="row" flexWrap="wrap" columnGap={3} rowGap={2}>
          ...
          <Chip
            ...
            label="Success"
            color="success"
            avatar={<Avatar alt="User" src="/static/user/user-17.png" />}
          />
          <Chip
            variant="outlined"
            label="Warning"
