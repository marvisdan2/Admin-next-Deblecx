...
const LinkList = styled("div")(({ theme }) => ({
  ...
  a: { color: theme.palette.grey[isDark(theme) ? 300 : 700] }
}));

const StyledRoot = styled("div")(({ theme }) => ({
  paddingTop: "5rem",
  ...(isDark(theme) && { backgroundColor: theme.palette.grey[800] }),
  "& .divider": { marginTop: "6rem" },
  [theme.breakpoints.down("sm")]: { paddingTop: "4rem", "& .divider": { marginTop: "3rem" } }
}));
