...
export default function MuiAutocompletePageView() {
  ...
  const creatableOptionLabel = (option: string | FilmOptionType) => {
    if (typeof option === 'string') return option
    if (option.inputValue) return option.inputValue
    return option.label
  }

  const creatableFilterOptions = (
  ...
  return (
    <ComponentPageLayout title="Autocomplete">
        ...
        <Grid item lg={6} xs={12}>
          <Block title="Combo Box">
            <Autocomplete
              ...
              id="combo-box"
              options={top100Films}
              renderInput={(params) => <TextField {...params} size="medium" label="Combo Box" />}
            />
          </Block>
        </Grid>
        ...
        <Grid item lg={6} xs={12}>
          <Block title="Multiple values">
            <Autocomplete
              ...
              getOptionLabel={(option) => option.label}
              renderInput={(params) => <TextField {...params} size="medium" label="Tags" />}
            />
          </Block>
        </Grid>
        ...
        <Grid item lg={6} xs={12}>
          <Block title="Creatable values">
            <Autocomplete
              ...
              renderInput={(params) => <TextField {...params} size="medium" label="Creatable" />}
            />
          </Block>
        </Grid>
